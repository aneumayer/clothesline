<div class="row">
    ...
    <div class="col-3">
        <form method="post" action="<?php echo($_SERVER['REQUEST_URI']); ?>">
            <div class="form-group row">
                <label class="col-form-label col-5" for="login_old_password">Old Password:</label>
                <div class="col-7">
                    <input type="password" class="form-control" id="login_old_password" name="old_password" placeholder="Enter old password">
                </div>
            </div>
            <div class="form-group row">
                <label class="col-form-label col-5" for="login_password">New Password:</label>
                <div class="col-7">
                    <input type="password" class="form-control" id="login_passsword" name="password" placeholder="Enter password">
                </div>
            </div>
            <div class="form-group row">
                <label class="col-form-label col-5" for="login_password2">Confirm Password:</label>
                <div class="col-7">
