    ...
    <div class="col-md-6">
        <form method="post" action="<?php echo($_SERVER['REQUEST_URI']); ?>">
            <div class="form-group row">
                <label class="col-form-label col-md-5" for="first_name">First Name:</label>
                <div class="col-md-7">
            ...
            <div class="form-group row">
                <label class="col-form-label col-md-5" for="email">Email Address:</label>
                <div class="col-md-7">
            ...
            <div class="form-group row">
                <label class="col-form-label col-md-5" for="zip">Zip Code:</label>
                <div class="col-md-7">
                    <input type="zip" class="form-control" id="zip" name="zip" placeholder="Enter zip code" required="true" value="<?php echo($_POST['zip']); ?>">
                </div>
            </div>
            <div class="form-group row">
                <label class="col-form-label col-md-5" for="instruction">Special Instructions:</label>
                <div class="col-md-7">
                    <textarea name="instructions" class="form-control"><?php echo($_POST['instructions']); ?></textarea>
                </div>
            </div>
            <div class="form-group row">
                <label class="col-form-label col-md-5" for="categories">Categories:</label>
                <div class="col-md-7">
                    <?php
